...
open class LastCameraPositionRepositoryImpl(
    ...
    override fun getMapCameraPosition(): Observable<MapCameraPosition> = Observable
        .fromCallable {
    ...
    override fun hasMapCameraPosition(): Boolean = preferences.contains(KEY_MAP_LAST_TARGET_LAT)
