...
sealed class Event(val name: String) {
  ...
  class TopUpButtonPressed(val type: String, val price: Double, val zone: String? = null, val passDays: String? = null) : Event("Top_Up_button_pressed")
  class MykiTopupMoney(val amount: String, val currency: String?) : Event("Successful_Myki_Topup_Money")
  class MykiTopupPass(val passDays: String, val currency: String?, val price: String, val zone: String) : Event("Successful_Myki_Topup_Pass")
}