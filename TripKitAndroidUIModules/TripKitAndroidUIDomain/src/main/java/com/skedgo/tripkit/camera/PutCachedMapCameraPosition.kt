...
open class PutCachedMapCameraPosition @Inject constructor(
  ...
  open fun execute(cachedMapCameraPosition: CachedMapCameraPosition): Observable<Unit> = cachingDateTimeOfMapCameraPositionRepository.putCachingDateTime(cachedMapCameraPosition.cachingDateTime)
