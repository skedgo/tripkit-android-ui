...
open class GetOrdinaryTime @Inject constructor(
  ...
  open fun execute(dateTimeZone: DateTimeZone, service: TimetableEntry, vehicle: RealTimeVehicle? = null): String {
    val departureTime = printTime.print(DateTime(realTimeDeparture(service, vehicle) * 1000, dateTimeZone))
