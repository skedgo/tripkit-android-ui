...
//                iconSrc.set(ContextCompat.getDrawable(context, R.drawable.ic_noresults))
//            }
...
//                iconSrc.set(ContextCompat.getDrawable(context, R.drawable.ic_noconnection))
//            }
//            is SearchErrorType.OtherError -> {
//                title.set(context.getString(R.string.error_encountered))
//                actionText.set(context.getString(R.string.retry))
//                iconSrc.set(ContextCompat.getDrawable(context, R.drawable.ic_error))
//            }
//        }
    }
}
