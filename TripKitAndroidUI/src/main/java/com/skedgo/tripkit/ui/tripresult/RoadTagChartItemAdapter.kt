...
import com.skedgo.tripkit.ui.databinding.ItemRoadTagChartBinding
...
class RoadTagChartItemAdapter @Inject constructor() :
    RecyclerView.Adapter<RoadTagChartItemAdapter.Holder>(),
    ...
    class Holder(val binding: ItemRoadTagChartBinding) : RecyclerView.ViewHolder(binding.root) {
        companion object {
            fun from(parent: ViewGroup, layout: Int): Holder {
                val inflater = LayoutInflater.from(parent.context)
                val binding =
                    DataBindingUtil.inflate<ItemRoadTagChartBinding>(
                        inflater, layout,
                        parent, false
                    )
