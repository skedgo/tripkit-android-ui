...
public class ServiceStopMapFragment
  ...
  @Inject Lazy<VehicleMarkerIconCreator> vehicleMarkerIconCreatorLazy;
  @Inject
  ...
  @Inject ServiceStopMapViewModel viewModel;

  /* TODO: Replace with RxJava-based approach. */
  @Deprecated @Inject Bus bus;
...
//        .subscribe(__ -> whenSafeToUseMap(map -> map.setMyLocationEnabled(true)));
  ...
  @SuppressLint("MissingPermission") private void setupMap() {
    whenSafeToUseMap(map -> {
