...
internal class PreferredTransferTimeRepositoryImpl constructor(
  ...
  override suspend fun getPreferredTransferTime(
      ...
      val transferTime = prefs.getString(resources.getString(R.string.pref_transfer_time), null)?.toLong()
      return if (transferTime != null) { Duration.ofMinutes(transferTime) } else { defaultIfEmpty() }
  }
