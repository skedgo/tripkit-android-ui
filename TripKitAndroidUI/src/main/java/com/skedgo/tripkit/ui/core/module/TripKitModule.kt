...
@Module
class TripKitModule {
  @Provides internal fun regionService(): RegionService
      = TripKit.getInstance().regionService

  @Provides
  @Singleton internal fun routeService(): RouteService
      = SingleRouteService(TripKit.getInstance().routeService)

  @Provides internal fun locationInfoService(): com.skedgo.tripkit.LocationInfoService
  ...
  @Provides internal fun tripPreferences(context: Context): com.skedgo.tripkit.TripPreferences =
      DefaultTripPreferences(context.getSharedPreferences(
          "TripPreferences", Context.MODE_PRIVATE
      ))

  @Provides internal fun tripPreferencesFactory(tripPreferences: com.skedgo.tripkit.TripPreferences):
  ...
  @Provides internal fun configCreator(
          ...
          tripPreferences: TripPreferences): ConfigRepository {
